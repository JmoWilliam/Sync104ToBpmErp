...
BPM      | OrganizationUnit     | organizationUnitType  | 組織單元類型           | (待確認)
...
ERP      | gem_file             | GEM05                 | 是否為會計部門          | (待確認)
ERP      | gem_file             | GEM06                 | ~~No Use~~ (保留)      | (空白)
ERP      | gem_file             | GEM07                 | 費用類別               | (待確認)
ERP      | gem_file             | GEM08                 | ~~No Use~~ (保留)      | (空白)
ERP      | gem_file             | GEM09                 | 管理類別 (1=成本中心 2=利潤中心) | (待確認)
ERP      | gem_file             | GEM10                 | 對應成本中心            | (待確認)
ERP      | gem_file             | GEM11                 | ~~No Use~~ (保留)      | (空白)
ERP      | gem_file             | GEMACTI               | 資料有效碼             | /api/os/dept.IS_ACT (1→Y, 0→N)
ERP      | gem_file             | GEMUSER               | 資料所有者             | 'SYNC104'
ERP      | gem_file             | GEMGRUP               | 資料所有部門           | (待確認)
ERP      | gem_file             | GEMMODU               | 資料修改者             | 'SYNC104'
ERP      | gem_file             | GEMDATE               | 最近修改日             | SYSDATE
ERP      | gem_file             | GEMORIG               | 資料建立部門           | (待確認)
ERP      | gem_file             | GEMORIU               | 資料建立者             | 'SYNC104'
```
...
ERP      | geu_file             | GEUUSER               | 資料所有者             | 'SYNC104'
ERP      | geu_file             | GEUGRUP               | 資料所有群             | (待確認)
ERP      | geu_file             | GEUMODU               | 資料更改者             | 'SYNC104'
ERP      | geu_file             | GEUDATE               | 最近修改日             | SYSDATE
ERP      | geu_file             | GEUORIG               | 資料建立部門           | (待確認)
ERP      | geu_file             | GEUORIU               | 資料建立者             | 'SYNC104'
```
...
ERP      | abd_file             | ABDUSER               | 資料所有者             | 'SYNC104'
ERP      | abd_file             | ABDGRUP               | 資料所有部門           | (待確認)
ERP      | abd_file             | ABDMODU               | 資料修改者             | 'SYNC104'
ERP      | abd_file             | ABDDATE               | 最近修改日             | SYSDATE
ERP      | abd_file             | ABDORIG               | 資料建立部門           | (待確認)
ERP      | abd_file             | ABDORIU               | 資料建立者             | 'SYNC104'
```
...
ERP      | gen_file             | GEN03                 | 部門代號               | (待確認)
ERP      | gen_file             | GEN04                 | 職稱                   | (待確認)
ERP      | gen_file             | GEN05                 | 不確定                 | (待確認)
ERP      | gen_file             | GEN06                 | 不確定                 | (待確認)
ERP      | gen_file             | GENACTI               | 資料有效碼             | 'Y'
ERP      | gen_file             | GENUSER               | 資料所有者             | 'SYNC104'
ERP      | gen_file             | GENGRUP               | 資料所有群             | (待確認)
ERP      | gen_file             | GENMODU               | 資料修改者             | 'SYNC104'
ERP      | gen_file             | GENDATE               | 最近修改日             | SYSDATE
ERP      | gen_file             | TA_GEN07              | 擴充欄位               | (待確認)
ERP      | gen_file             | TA_GEN08              | 擴充欄位               | (待確認)
```
